...
export type MarkdownRemarkFrontmatter = {
  ...
  hideDownloads?: Maybe<Scalars['Boolean']>;
};


export type GithubRelease = Node & {
  id: Scalars['ID'];
  parent?: Maybe<Node>;
  children: Array<Node>;
  internal: Internal;
...
export type GithubReleaseDateArgs = {
  formatString?: Maybe<Scalars['String']>;
  fromNow?: Maybe<Scalars['Boolean']>;
  difference?: Maybe<Scalars['String']>;
  locale?: Maybe<Scalars['String']>;
...
export type Query = {
  ...
  githubRelease?: Maybe<GithubRelease>;
  allGithubRelease: GithubReleaseConnection;
...
export type QueryGithubReleaseArgs = {
  id?: Maybe<StringQueryOperatorInput>;
  parent?: Maybe<NodeFilterInput>;
  children?: Maybe<NodeFilterListInput>;
  internal?: Maybe<InternalFilterInput>;
...
export type QueryAllGithubReleaseArgs = {
  filter?: Maybe<GithubReleaseFilterInput>;
  sort?: Maybe<GithubReleaseSortInput>;
  skip?: Maybe<Scalars['Int']>;
  limit?: Maybe<Scalars['Int']>;
};
...
export type MarkdownRemarkFrontmatterFilterInput = {
  title?: Maybe<StringQueryOperatorInput>;
  path?: Maybe<StringQueryOperatorInput>;
  hideDownloads?: Maybe<BooleanQueryOperatorInput>;
};
...
export type FileFieldsEnum =
  ...
  | 'childrenMarkdownRemark___frontmatter___hideDownloads'
  ...
  | 'childMarkdownRemark___frontmatter___hideDownloads'
...
export type GithubReleaseConnection = {
  totalCount: Scalars['Int'];
  edges: Array<GithubReleaseEdge>;
  nodes: Array<GithubRelease>;
  pageInfo: PageInfo;
  distinct: Array<Scalars['String']>;
  group: Array<GithubReleaseGroupConnection>;
};


export type GithubReleaseConnectionDistinctArgs = {
  field: GithubReleaseFieldsEnum;
};


export type GithubReleaseConnectionGroupArgs = {
  skip?: Maybe<Scalars['Int']>;
  limit?: Maybe<Scalars['Int']>;
  field: GithubReleaseFieldsEnum;
};
...
export type GithubReleaseEdge = {
  next?: Maybe<GithubRelease>;
  node: GithubRelease;
  previous?: Maybe<GithubRelease>;
};

export type GithubReleaseFieldsEnum =
  | 'id'
  | 'parent___id'
  | 'parent___parent___id'
  | 'parent___parent___parent___id'
...
export type GithubReleaseGroupConnection = {
  totalCount: Scalars['Int'];
  edges: Array<GithubReleaseEdge>;
  nodes: Array<GithubRelease>;
  pageInfo: PageInfo;
...
export type GithubReleaseFilterInput = {
  id?: Maybe<StringQueryOperatorInput>;
  parent?: Maybe<NodeFilterInput>;
  children?: Maybe<NodeFilterListInput>;
  internal?: Maybe<InternalFilterInput>;
...
export type GithubReleaseSortInput = {
  fields?: Maybe<Array<Maybe<GithubReleaseFieldsEnum>>>;
  order?: Maybe<Array<Maybe<SortOrderEnum>>>;
};
...
export type PageTemplateQuery = { markdownRemark?: Maybe<(
    ...
    & { frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'path' | 'title' | 'hideDownloads'>> }
  )> };

export type BtdMarkdownQueryVariables = Exact<{ [key: string]: never; }>;


export type BtdMarkdownQuery = { allGithubRelease: { edges: Array<{ node: Pick<GithubRelease, 'id' | 'title' | 'url' | 'description' | 'date'> }> } };
